<section id="costs" class="section costs">
    ...
    <div class="picts">
            ...
            <img src="<?php bloginfo('template_directory'); ?>/img/costs-min.png" alt="Diseños" class="design1" data-aos="fade-right"  data-aos="flip-up" data-aos-delay="500" data-aos-offset="100"/>
        </div>
        <div class="text">
            <h3>Logrando un <br />
